...
public:
    ...
    constant_medium(std::shared_ptr<hittable> b, float d, HMM_Vec3 c)
    ...
    bool hit(const ray& r, interval ray_t, hit_record& rec) const override
    {
        ...
        auto ray_length = HMM_Len(r.direction());
        auto distance_inside_boundary = (rec2.t - rec1.t) * ray_length;
        auto hit_distance = neg_inv_density * std::logf(random_float());
        ...
        rec.normal = HMM_V3(1,0,0);  // arbitrary
